...
2、我的CUDA-version是12.3   那么就需要安装PyTorch + CUDA 12.1版本
首先安装pytorch：
---pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu121
安装完成后测试：  ---python -c "import torch; print(torch.cuda.is_available(), torch.version.cuda)"    (正确的话就会显示True  12.1)

3、安装nnU-Netv2
---pip install nnunetv2==2.3.1
安装 nnU-Net 所需依赖（医学图像库）  
